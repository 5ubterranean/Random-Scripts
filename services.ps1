#Script taken from https://github.com/SpecterOps/at-ps/blob/master/Labs/Day%201/Service%20Binaries/services.ps1 I just added the version printing
...
#>
    ...
    function Get-PEMetaData {
        ...
        try {
            ...
            $ProductVersion = (Get-ItemProperty $FullPath).VersionInfo.ProductVersion
            $FileVersion = (Get-ItemProperty $FullPath).VersionInfo.FileVersion
            ...
            $Out | Add-Member Noteproperty 'ProductVersion' $ProductVersion
            $Out | Add-Member Noteproperty 'FileVersion' $FileVersion
            $Out
        }
        catch {
