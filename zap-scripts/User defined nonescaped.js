...
//Modified version of "User defined attacks" (Active Rule script) that does not escape payloads, line that limits to one alert per parameter commented
var attacks = 
  "<>\"'%;)(&+",
  "'",
  "' --",
...
function scan(as, msg, param, value) {
  ...
  for (var i in attacks) {
    ...
    //To avoid html encoding on the payloads
    as.setEscapedParam(msg, param, attacks[i]); 
